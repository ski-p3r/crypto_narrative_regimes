...
def run_all_features():
    """
    Compute all advanced features and aggregate alerts (no webhooks).
    """
    ...
    try:
        ...
        # Add alert summaries (no webhook dispatch)
        if cascade_result.get("cascade_events"):
        ...
        if funding_result.get("funding_anomalies"):
        ...
        if funding_result.get("reversal_signals"):
        ...
        if mtf_result.get("primary_regimes"):
        ...
        if correlation_result.get("divergence_events"):

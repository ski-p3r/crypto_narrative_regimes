...
Successfully implemented 5 advanced market analysis features for your crypto narrative regime system.
...
#     results["alerts"].append({"type": "REGIME_CONFIRMED", "symbol": regime_data.get("symbol")})
```
...
4. **Optimize**: Tune thresholds based on real data
...
4. Check environment: `env | grep -E "DB_URL|OPENAI"`
